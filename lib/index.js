...
function columnMapTransformator(sudoku) {
	return sudoku.map(function(row, i) {
...
console.log(columnMapTransformator(validSudoku));
...
function squareMapTransformator(sudoku) {
	//smth
}
